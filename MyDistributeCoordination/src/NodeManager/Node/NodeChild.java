...
//        super(port);
    ...
    public NodeChild(String owner, String nodeType, String currentNode, long updateTime, String password,TreeSet<DateNode> nodevalve,int port) throws RemoteException{
        this(port);
        this.owner = owner;
...
//        try {
//            if (this.getThisUpdateTime() < o.getThisUpdateTime())
//                return -1;
//            else if(this.getThisUpdateTime()>o.getThisUpdateTime())
//                return 1;
//            else return 0;
